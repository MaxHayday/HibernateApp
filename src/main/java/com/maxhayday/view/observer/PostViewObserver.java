package com.maxhayday.view.observer;

import com.maxhayday.controller.PostController;
import com.maxhayday.controller.UserController;
...
public class PostViewObserver implements ViewObserver{
    ...
    public void update(Long id) throws IOException {
        ...
        data = reader.readLine();
        postController.update(post.getId(), data,post);
    }
