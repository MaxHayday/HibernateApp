...
public class PostTestData {
    ...
    public static Post testDataOfPostForCreating() {
        Post post = new Post(3L, "Post 1 of Ira", Timestamp.valueOf("2021-01-03 8:43:10"), Timestamp.valueOf("2021-01-03 8:43:10"));
        return post;
    }

    public static Post testDataOfPostForUpdating() {
        Post post = new Post(1L, "Updated Post 1 of Max", Timestamp.valueOf("2021-01-03 8:43:10"), Timestamp.valueOf("2021-01-03 8:43:10"));
        return post;
    }
    ...
    public static List<Post> expectedDataOfAllPosts() {
        ...
        post1 = new Post(2L, "Post 1 of Ola", Timestamp.valueOf("2021-01-03 8:43:10"), Timestamp.valueOf("2021-01-03 8:43:10"));
        postList.add(post1);
